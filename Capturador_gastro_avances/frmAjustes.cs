...
namespace Capturador_gastro_avances
{
    public partial class frmAjustes : Form
    {
        ...
        private async Task btnActualizar_ClickAsync(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            using (var manager = UpdateManager.GitHubUpdateManager("https://github.com/Elchuzo/Capturador-gastro-avances"))
            {
